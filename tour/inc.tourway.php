...
<!-- <div class="section-download">
    ...
    <div class="section-download__box">
        ...
        <p class="text_banner_center1_c">เส้นทางท่องเที่ยว</p>
        <p class="text_banner_center2_c">ท่องเที่ยวชุมชนนครปฐม</p> 
        </div>
    </div>
    </div>
</div> -->
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-12">  
            <div class="row border_box1"> 
                <div class="col-6">
                    <p class="text_ta1"><?php echo $commname;?></p>
                </div>
                <div class="col-6 text-right">
                    <p class="text_ta2"><a href="<?php echo $link_tab; ?>">เส้นทางท่องเที่ยว</a></p>
                </div>  
            </div>
                                    ...
                                    if($thispage['path']){
                                        ...
                                        foreach( $thispage['path'] as $k1 => $v1) {
                                            ...
                                            <div id="box_<?php echo $k;?>">
                                                    ...
                                                    <div class="text-right"><span class="icon-location-pin"></span><span class="text_tab1 ml-2"> <span class="place<?php echo $k;?>">...</span></span></div> 
                                    ...
                                    <div class="col-6 col-sm-8 ft_margin <?php echo $setbox;?> box_content" id="box_content_<?php echo $k;?>"> 
                                        <div class="row">
                                            <div class="col-12 text_tab4"> 
                                                <img class="pic_icon_car" src="img/icon_cardrive.png">  
                                                <span class="text_ta7">จุดที่ <?php echo $k;?> <?php echo $v1['title'];?></span>  <span class="txt_nearme hidden txt_nearme<?php echo $k;?>"> สถานที่ท่องเที่ยวใกล้คุณ</span>
                                                <p class="mt-1 text_tab3"><?php echo $v1['detail'];?> </p>  
                                                
                                                <div class="text_tab3"><span class="icon-location-pin"></span><span class=" ml-3"><?php echo $v1['contact']['address'];?></span></div>
                                                <div class="mt-2 text_tab3"><span class="icon-call-in"></span><span class=" ml-3">
                                                ...
                                                <div class="mt-4 text_tab3">
                                                    <a class="btn btn_navi" id="link_navigatesub_<?php echo $k;?>" target="_blank"> <img src="img/navi_icon2.png" > &nbsp; นำทาง </a>
                                                </div> 
                                            </div> 
